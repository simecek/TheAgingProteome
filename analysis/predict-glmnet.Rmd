...
The signatures of aging seem to be shared within the tissue. For kidney and somewhat for heart we observe mRNA and protein based predictions to be correlated.

The between-tissues story is more complicated. On mRNA level, we observe a striking correlation caused by several shared age-outliers (F787, M989, M907, F1208). On protein level we do not see anything like that and after adjust for age group, the correlation between predictions is not statistically significant. 
